...
//! ## Algorithm
//!
//! 1. Compute ORCA half-plane constraints for each neighbor
//! 2. Project velocity onto constraints sequentially (greedy approach)
//! 3. Return the projected velocity
//!
//! ## When to Use
//!
//! Use this module when:
//! - Speed is more important than optimality
//! - You have many agents and need real-time performance
//! - The scenario is not too crowded
//!
//! ## Limitations
//!
//! - May not find the optimal velocity (greedy projection order matters)
//! - Can produce suboptimal evasive maneuvers in complex scenarios
//! - Less robust to symmetric/deadlock situations
//!
//! For the correct algorithm from the original paper, use the `orca` module instead.
